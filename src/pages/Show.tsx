...
const Show: React.FC = () => {
  ...
  return (
    <MainLayout>
      <section className="grid h-full grid-flow-row auto-rows-max grid-cols-2">
        <article className="rounded-2xl border border-black shadow-lg shadow-black dark:border-white m-3 p-5 flex flex-col justify-center">
          <img
            ...
            {memoizedPokemonData.types.map((item, index) => (
              <p
                ...
                className={`overflow-hidden break-all rounded-full p-2 text-center font-arcade text-md capitalize tracking-wide text-white ${
                  index === 0 ? "bg-indigo-400" : index === 1 ? "bg-red-400" : ""
                }`}
              >
                {item.type.name}
              </p>
        ...
        <article className="rounded-2xl border border-black shadow-lg shadow-black dark:border-white m-3 p-5 undefined col-span-2 undefined">
        ...
        <article className="rounded-2xl border border-black shadow-lg shadow-black dark:border-white m-3 p-5 undefined undefined undefined">
        ...
        <div className="m-3 p-5 flex flex-col justify-center col-span-2 undefined">
          <button
